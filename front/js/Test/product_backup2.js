...
function productSheet(product) {
    ...
    btnAddCart.addEventListener("click", (test)=>{
        ...
        // localStorage.setItem(idColorProduct, JSON.stringify(selectedProduct));
        ...
        let productRegisterLocalStorage = JSON.parse(localStorage.getItem(idColorProduct));
        ...
        if(!localStorage.getItem(idColorProduct)) {
            console.log("yes");
